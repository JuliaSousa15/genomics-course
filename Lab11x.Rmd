...
p = p + scale_colour_brewer(type="qual", palette="Set1")
p + ggtitle("MDS/PCoA on weighted-UniFrac distance, Global Patterns")

```


# Tutorial 2: Alpha Diversity

#Loading packages, set parameters
...
#Trying different ordination methods, distances
...
ig <- make_network(enterotype, fist.fun="bray:, max.dist=0.3")
plot_network(ig, enterotype, color="SeqTech", shape="Enterotype", line_weight=0.4, label=NULL)
