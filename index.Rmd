...
* Lab 9x: [Programming in R- Control Structures and Functions](Lab9x.html)

* Lab 10: [Population genetics based on high throughput sequencing (HTS)](Lab10.html)

* Lab 11: [Microbiome Analysis using data2 and phyloseq](Lab11.html)

* Lab 11x: [Microbiome Aaalysis using phyloseq](Lab11x.html)
