...
The file wouldn't knit, but was able to produce an output. Here are screenshots:

![This is what the code looked like](html_ss.png)

![This is the output that was produced in my web browser](code_ss.png)
