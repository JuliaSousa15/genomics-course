...
ggtree(tree) + geom_nodepoint(alpha = 0.5, color = "orange", size = 3) + geom_tippoint(color = "purple", shape = "diamond") + geom_tiplab(color = "purple") + ggtitle("Phylogenetic tree with new aesthetics")
